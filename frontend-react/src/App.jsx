...
const SAMPLE_CATS = [
  { id: 1,  img: 'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=400&h=300&fit=crop',  breed: 'Persian',             confidence: 91 },
  { id: 2,  img: 'https://images.unsplash.com/photo-1594900060009-89cda7e5a3cd?w=400&h=300&fit=crop',  breed: 'Maine Coon',          confidence: 89 },
  { id: 3,  img: 'https://images.unsplash.com/photo-1533743983669-94fa5c4338ec?w=400&h=300&fit=crop',  breed: 'British Shorthair',   confidence: 93 },
  { id: 4,  img: 'https://images.unsplash.com/photo-1513360371669-4adf3dd7dff8?w=400&h=300&fit=crop',  breed: 'Siyam',               confidence: 87 },
  { id: 5,  img: 'https://images.unsplash.com/photo-1550159930-40066082a4fc?w=400&h=300&fit=crop',    breed: 'Habeş Kedisi',        confidence: 86 },
  { id: 6,  img: 'https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=400&h=300&fit=crop',  breed: 'Bengal',              confidence: 88 },
  { id: 7,  img: 'https://images.unsplash.com/photo-1519479651571-a2c9e714fee2?w=400&h=300&fit=crop',  breed: 'Russian Blue',        confidence: 90 },
  { id: 8,  img: 'https://images.unsplash.com/photo-1555685812-4b943f1cb0eb?w=400&h=300&fit=crop',    breed: 'Birman',              confidence: 88 },
  { id: 9,  img: 'https://images.unsplash.com/photo-1568043432885-75710c77fd61?w=400&h=300&fit=crop',  breed: 'American Shorthair',  confidence: 85 },
  { id: 10, img: 'https://images.unsplash.com/photo-1573865526739-10659fec78a5?w=400&h=300&fit=crop',  breed: 'Bombay',              confidence: 89 },
  { id: 11, img: 'https://images.unsplash.com/photo-1548247416-ec66f4900b2e?w=400&h=300&fit=crop',    breed: 'Norveç Orman Kedisi', confidence: 84 },
  { id: 12, img: 'https://images.unsplash.com/photo-1596854407944-bf87f6fdd49e?w=400&h=300&fit=crop',  breed: 'Sfenks',              confidence: 83 },
  { id: 13, img: 'https://images.unsplash.com/photo-1571566882372-1598d88abd90?w=400&h=300&fit=crop',  breed: 'Scottish Fold',       confidence: 92 },
  { id: 14, img: 'https://images.unsplash.com/photo-1561948955-570b270e7c36?w=400&h=300&fit=crop',    breed: 'Chartreux',           confidence: 86 },
  { id: 15, img: 'https://images.unsplash.com/photo-1590418606746-018840f9ced2?w=400&h=300&fit=crop',  breed: 'Ankara Kedisi',       confidence: 87 },
  { id: 16, img: 'https://images.unsplash.com/photo-1529778873920-4da4926a72c2?w=400&h=300&fit=crop',  breed: 'Ocicat',              confidence: 85 },
  { id: 17, img: 'https://images.unsplash.com/photo-1535293478971-0a5e7a6c2230?w=400&h=300&fit=crop',  breed: 'Tonkinese',           confidence: 83 },
  { id: 18, img: 'https://images.unsplash.com/photo-1535295972055-1c762f4483e5?w=400&h=300&fit=crop',  breed: 'Burmese',             confidence: 90 },
  { id: 19, img: 'https://images.unsplash.com/photo-1518791841217-8f162f1912da?w=400&h=300&fit=crop',  breed: 'Savana',              confidence: 91 },
  { id: 20, img: 'https://images.unsplash.com/photo-1543852786-1cf6624b9987?w=400&h=300&fit=crop',    breed: 'Munchkin',            confidence: 81 },
  { id: 21, img: 'https://images.unsplash.com/photo-1591825729269-caeb344f6df2?w=400&h=300&fit=crop',  breed: 'Cornish Rex',         confidence: 88 },
  { id: 22, img: 'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=400&h=300&fit=crop',  breed: 'Egzotik Shorthair',   confidence: 81 },
  { id: 23, img: 'https://images.unsplash.com/photo-1535268647677-300dbf3d78d1?w=400&h=300&fit=crop',  breed: 'Havana Kedisi',       confidence: 82 },
  { id: 24, img: 'https://images.unsplash.com/photo-1609220136736-443140cfeaa8?w=400&h=300&fit=crop',  breed: 'Manks',               confidence: 85 },
  { id: 25, img: 'https://images.unsplash.com/photo-1568043432885-75710c77fd61?w=400&h=300&fit=crop',  breed: 'Amerikan Bobtail',    confidence: 80 },
  { id: 26, img: 'https://images.unsplash.com/photo-1591825729269-caeb344f6df2?w=400&h=300&fit=crop',  breed: 'Selkirk Rex',         confidence: 84 },
  { id: 27, img: 'https://images.unsplash.com/photo-1513360371669-4adf3dd7dff8?w=400&h=300&fit=crop',  breed: 'Snowshoe',            confidence: 81 },
];
