...
const SAMPLE_CATS = [
  { id: 1,  img: '/cats/persian.jpg',              breed: 'Persian',             confidence: 91 },
  { id: 2,  img: '/cats/maine-coon.jpg',           breed: 'Maine Coon',          confidence: 89 },
  { id: 3,  img: '/cats/british-shorthair.jpg',    breed: 'British Shorthair',   confidence: 93 },
  { id: 4,  img: '/cats/siamese.jpg',              breed: 'Siyam',               confidence: 87 },
  { id: 5,  img: '/cats/abyssinian.jpg',           breed: 'Habeş Kedisi',        confidence: 86 },
  { id: 6,  img: '/cats/bengal.jpg',               breed: 'Bengal',              confidence: 88 },
  { id: 7,  img: '/cats/russian-blue.jpg',         breed: 'Russian Blue',        confidence: 90 },
  { id: 8,  img: '/cats/birman.jpg',               breed: 'Birman',              confidence: 88 },
  { id: 9,  img: '/cats/american-shorthair.jpg',   breed: 'American Shorthair',  confidence: 85 },
  { id: 10, img: '/cats/bombay.jpg',               breed: 'Bombay',              confidence: 89 },
  { id: 11, img: '/cats/norwegian-forest-cat.jpg', breed: 'Norveç Orman Kedisi', confidence: 84 },
  { id: 12, img: '/cats/sphynx.jpg',               breed: 'Sfenks',              confidence: 83 },
  { id: 13, img: '/cats/scottish-fold.jpg',        breed: 'Scottish Fold',       confidence: 92 },
  { id: 14, img: '/cats/chartreux.jpg',            breed: 'Chartreux',           confidence: 86 },
  { id: 15, img: '/cats/turkish-angora.jpg',       breed: 'Ankara Kedisi',       confidence: 87 },
  { id: 16, img: '/cats/ocicat.jpg',               breed: 'Ocicat',              confidence: 85 },
  { id: 17, img: '/cats/tonkinese.jpg',            breed: 'Tonkinese',           confidence: 83 },
  { id: 18, img: '/cats/burmese.jpg',              breed: 'Burmese',             confidence: 90 },
  { id: 19, img: '/cats/savannah.jpg',             breed: 'Savana',              confidence: 91 },
  { id: 20, img: '/cats/munchkin.jpg',             breed: 'Munchkin',            confidence: 81 },
  { id: 21, img: '/cats/cornish-rex.jpg',          breed: 'Cornish Rex',         confidence: 88 },
  { id: 22, img: '/cats/exotic-shorthair.jpg',     breed: 'Egzotik Shorthair',   confidence: 81 },
  { id: 23, img: '/cats/havana-brown.jpg',         breed: 'Havana Kedisi',       confidence: 82 },
  { id: 24, img: '/cats/manx.jpg',                 breed: 'Manks',               confidence: 85 },
  { id: 25, img: '/cats/american-bobtail.jpg',     breed: 'Amerikan Bobtail',    confidence: 80 },
  { id: 26, img: '/cats/selkirk-rex.jpg',          breed: 'Selkirk Rex',         confidence: 84 },
  { id: 27, img: '/cats/snowshoe.jpg',             breed: 'Snowshoe',            confidence: 81 },
];
